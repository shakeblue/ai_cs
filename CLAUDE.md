...
- When create files test, debug, investigate, images, output, temporary files, please mark or put group them together in a certain folder to easy manage and delete. 
- When create guide md files, please put them under guide folder.

## Crawler
- When work with crawler, lets activate the virtual environemt and run scripts
